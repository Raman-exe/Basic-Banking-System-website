...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
   ...
   <!--  <i class="d-inline-block  fa fa-building fa-fw"></i> --><?php echo "EXYZ Bank"; ?>
  </a>
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welecome to our Bank</h4>
     ...
     ?></p>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item active">
            <img class="card-img-top" src="images/Image 1.jpg" alt="First slide" style="max-height: 500px">
          </div>
          <div class="carousel-item">
            <img class="card-img-top" src="images/Image 2.jpg" alt="Second slide" style="max-height: 500px">
          </div>
          <div class="carousel-item">
            <img class="card-img-top" src="images/Image 3.jpg" alt="Third slide" style="max-height: 500px">
          </div>
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/accounts1.jpg" style="max-height: 250px;min-height: 250px" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/money transfer.jpg" alt="Card image cap" style="max-height: 250px;min-height: 250px">
        <div class="card-body">
    ...
    <div class="row" style="padding: 22px">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/bell.jpg" style="max-height: 250px;min-height: 250px" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/contact us.jpg" alt="Card image cap" style="max-height: 250px;min-height: 250px">
        <div class="card-body">
